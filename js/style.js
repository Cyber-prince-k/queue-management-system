...
const translations = {
    en: {
        ...
        about_qech: 'About QECH',
        about_qech_desc: "Queen Elizabeth Central Hospital is Malawi's largest referral hospital, providing quality healthcare services to the nation.",
        ...
        stats_patients_waiting: 'Patients Waiting',
        stats_currently_serving: 'Currently Serving',
        stats_priority_cases: 'Priority Cases',
        current_queue: 'Current Queue',
        btn_call_next: 'Call Next Patient',
        btn_pause_queue: 'Pause Queue',
        btn_resume_queue: 'Resume Queue',
        btn_queue_paused: 'Queue Paused',
        confirm_mark_attended: 'Mark this patient as attended?',
        btn_mark_attended: 'Mark Attended',
        btn_cancel: 'Cancel',
        prompt_reassign_to: 'Reassign patient to:',
        prompt_enter_dept_code: 'Enter department code (opd, maternity, emergency, pediatrics):',
        err_invalid_department: 'Invalid department code',
        msg_switched_to: 'Switched to',
        // Common form labels
        ...
        lbl_patient_id: 'Patient ID Number',
        lbl_address: 'Address',
    ...
    ny: {
        ...
        about_qech: 'Za QECH',
        about_qech_desc: 'Queen Elizabeth Central Hospital ndi chipatala chachikulu cha boma ku Malawi chomapereka chithandizo chapamwamba.',
        quick_links: 'Maulalo Aufupi',
        contact: 'Lumikizanani Nafe',
        patient_portal: 'Khomo la Odwala',
        staff_portal: 'Khomo la Ogwira Ntchito',
        admin_portal: 'Khomo la Oyendetsa',
        label_select_department: 'Sankhani Dipatimenti:',
        queue_management: 'Kasamalidwe ka Mzere',
        stats_patients_waiting: 'Akudikirira',
        stats_currently_serving: 'Akugwiritsidwa Ntchito Pano',
        stats_priority_cases: 'Milandu Yofunika',
        current_queue: 'Mzere Wapano',
        btn_call_next: 'Itanani Wotsatira',
        btn_pause_queue: 'Imitsani Mzere',
        btn_resume_queue: 'Yambitsaninso Mzere',
        btn_queue_paused: 'Mzere Waimitsidwa',
        confirm_mark_attended: 'Tsimikizani kuti wodwalayu wachitidwa?',
        btn_mark_attended: 'Tsimikizani Wachitidwa',
        btn_cancel: 'Lekani',
        prompt_reassign_to: 'Sinthani wodwala kupita ku dipatimenti ina:',
        prompt_enter_dept_code: 'Lowetsani code ya dipatimenti (opd, maternity, emergency, pediatrics):',
        err_invalid_department: 'Code ya dipatimenti yosavomerezeka',
        msg_switched_to: 'Yasintha ku',
        // Common form labels
        lbl_username: 'Dzina Lolowera',
        lbl_password: 'Chinsinsi',
        lbl_confirm_password: 'Tsimikizani Chinsinsi',
        lbl_name: 'Dzina',
        lbl_role: 'Udindo',
        lbl_phone: 'Foni',
        lbl_email: 'Imelo',
        lbl_department: 'Dipatimenti',
        lbl_patient_name: 'Dzina la Wodwala',
        lbl_patient_id: 'Nambala ya ID ya Wodwala',
        lbl_address: 'Adilesi',
        lbl_service_type: 'Mtundu wa Utumiki',
        lbl_priority: 'Chofunika',
        lbl_appointment_date: 'Tsiku la Msonkhano',
        lbl_appointment_time: 'Nthawi ya Msonkhano',
        btn_submit: 'Tumizani',
        btn_register: 'Lembetsani',
        btn_login2: 'Lowani',
